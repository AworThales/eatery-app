...
const CheckoutForm = ({ price, cart }) => {
  ...
  const { user } = useAuth();
  console.log("user from checkoutform:",user);
    ...
    if (paymentIntent.status === "succeeded") {
      ...
      axiosSecure
        ...
        .then((res) => {
          ...
          navigate("/order");
          alert("Transaction Completed Successfullu!");
    ...
    <div className="flex flex-col sm:flex-row justify-between gap-6 items-start">
      ...
      <div className="md:w-1/3 w-full flex flex-col space-y-8 justify-center items-center  py-10">
        <div className="flex shadow-xl md:mx-6 rounded-md">
          <div className="w-44">
            <img
              src="https://img.freepik.com/free-vector/secure-payment-landing-page-concept_23-2148535366.jpg"
              alt="Album"
